    ...
    public void getOption(int option) throws FileNotFoundException {
        ...
        switch (option) {
            case 1:
                ...
                break;
            case 2:
                System.out.println("Book Info Format: id;title;authors;edition;publication;year;isbn;language;subject;status;numberOfCopy;");
                System.out.println("Sample: B11;The Troy stone;Rabley, Stephen;4th;Harlow, UK : Penguin Longman;2008;9781405869584;English;English Language;available;5;");
                System.out.println("Journal Info Format: id;title;publication;year;issn;language;subject;status;numberOfCopy;");
                System.out.println("Sample: J6;Known and strange things;New York : Random House;2016;Cole, Teju;English;Authorship;available;5;");
                System.out.println("Dvd Info Format: id;title;authors;publication;year;language;subject;status;numberOfCopy;");
                System.out.println("Sample: D9;Umberto D.;New York, NY: Janus Films;Janus Films;2019;English;Historical films;available;5;");
                System.out.print("Insert information: ");
                input = scannerOption.nextLine();
                itemList.addItem(input);
                break;
            case 3:
                System.out.println("ID Format For Book-Journal-Dvd: B1-J1-D1");
            ...
            case 4:
                ...
                break;
            case 5:
                System.out.println("Member Info Format: fullName;id;phone;email;address;expiredDate;status;");
                System.out.println("Sample: Vo Thanh Tri;0367020;0907645982;triivo@gmail.com;97 Ho Tung Mau;2022-01-01;active;");
                System.out.print("Insert information: ");
                input = scannerOption.nextLine();
            ...
            case 8:
                ...
                break;
            case 9:
                saveData("src\\asm_1\\Model\\Books.txt", itemList.books.get(0));
                saveData("src\\asm_1\\Model\\Journals.txt", itemList.journals.get(0));
                saveData("src\\asm_1\\Model\\Dvds.txt", itemList.dvds.get(0));
                saveData("src\\asm_1\\Model\\Members.txt", memberList.members.get(0));
                saveData("src\\asm_1\\Model\\Transactions.txt", transactionList.transactions.get(0));
