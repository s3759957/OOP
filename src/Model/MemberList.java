...
public class MemberList {
    ...
    public MemberList() throws FileNotFoundException {
        ...
        while (scannerMember.hasNext()) {
            Member info = new Member(scannerMember.next(),scannerMember.next(),scannerMember.next(),scannerMember.next(),scannerMember.next(),scannerMember.next(), scannerMember.next(),scannerMember.next(),scannerMember.next(),scannerMember.next(),scannerMember.next(),scannerMember.next());
            members.add(info);
...
//    }
    ...
    public void registerNewMember(String information) {
        String [] info = information.split(";");
            ...
            newMember.setItemsBorrowed(info[8],1);
            newMember.setItemsBorrowed(info[9],2);
            newMember.setItemsBorrowed(info[10],3);
            newMember.setItemsBorrowed(info[11],4);
